...
r = 0.2*R
F = 2
rot = disk(pos=(xi,yi,0), radius=R, diskcolor=color.red, wrap=1)
nonrot = disk(pos=(xi,-yi,0), radius=R, diskcolor=color.blue)
...
rot.force = arrow(axis=(F,0,0), color=color.cyan)
nonrot.force = arrow(axis=(F,0,0), color=color.cyan)
